...
import {View, Text, StyleSheet, TextInput, TouchableOpacity, FlatList, ImageBackground, Image, ScrollView, SafeAreaView, Alert} from 'react-native'
...
const AlbumInfoScreen = ({navigation}) => {
